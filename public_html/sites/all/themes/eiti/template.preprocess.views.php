...
/**
 * Implements eiti_preprocess_views_view() for homepage view.
 */
function __eiti_preprocess_views_view__homepage(&$vars) {
...
/**
 * Implements eiti_preprocess_views_view() for blog_listing view.
 */
function __eiti_preprocess_views_view__blog_listing(&$vars) {
  switch ($vars['view']->current_display) {
    case 'listing':
...
/**
 * Implements eiti_preprocess_views_view() for activities view.
 */
function __eiti_preprocess_views_view__activities(&$vars) {
  switch ($vars['view']->current_display) {
    case 'search_page':
...
/**
 * Implements eiti_preprocess_views_view_table() for activities view.
 */
function __eiti_preprocess_views_view_table__activities(&$vars) {
  switch ($vars['view']->current_display) {
    case 'search_page':
